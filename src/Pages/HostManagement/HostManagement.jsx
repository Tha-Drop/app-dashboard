...
import { useGetAllHostApproveQuery } from '../../redux/Api/hostApi'
import { imageUrl } from '../../redux/Api/baseApi'

const HostManagement = () => {
    const [tab, setTab] = useState(true)
    const [search, setSearch] = useState("")
    const { data } = useGetAllHostApproveQuery({});
        ...
        <div className='bg-white p-3 sm:p-4 md:p-6 rounded-lg'>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 sm:gap-0 mb-4 sm:mb-6">
                <div className="flex items-center gap-3">
                    ...
                    <span className='font-semibold text-lg sm:text-[20px] text-[#020123]'>Host</span>
                </div>
            ...
            <div>
                <p className='text-lg my-6 font-semibold text-[#020123]'>
                    {tab ? 'Show All Host Request' : 'All Host Info'}
                </p>
